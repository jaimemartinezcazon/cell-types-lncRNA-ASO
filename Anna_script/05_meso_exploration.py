...
adata = sc.read_h5ad('sc_analysis/adata_analyzed_meso_wt.h5ad')
...
sc.pl.umap(adata, color = ['Pou5f1','Dppa5a', 'Nanog','Klf4'], s = 50)
# Mesoderm markers
sc.pl.umap(adata, color = ['T','Meox1','Tbx6','Klf6'], s = 50)
...
go = {cl: go_analisis(genelist = list(dex[cl].index), background = list(adata.raw.var.index), pvth = 1e-1) for cl in dex}
