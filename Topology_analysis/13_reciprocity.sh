#!/bin/bash
#SBATCH --job-name=GRN_Reciprocity          # Sets the job's name shown in the queue
...
# Execute
srun -n1 conda run --prefix=/exports/ana-scarlab/jmartinezcazon/envs/celloracle_env python 13_reciprocity.py