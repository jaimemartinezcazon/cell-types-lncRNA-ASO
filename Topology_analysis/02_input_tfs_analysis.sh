#!/bin/bash
#SBATCH --job-name=GRN_TFs                  # Sets the job's name shown in the queue
...
# Execute
srun -n1 conda run --prefix=/exports/ana-scarlab/jmartinezcazon/envs/celloracle_env python 02_input_tfs_analysis.py