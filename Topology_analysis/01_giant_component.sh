#!/bin/bash
#SBATCH --job-name=GRN_Giant_Component          # Sets the job's name shown in the queue
...
#SBATCH --partition="all"   			    # Partition from wich the nodes will be selected # 
...
# Execute
srun -n1 conda run --prefix=/exports/ana-scarlab/jmartinezcazon/envs/celloracle_env python 01_giant_component.py