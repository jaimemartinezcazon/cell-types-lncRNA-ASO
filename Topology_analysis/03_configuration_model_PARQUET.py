...
# Null models go here — must match NULL_MODELS_DIR in the bow-tie script
NULL_MODELS_DIR = INPUT_DATA_DIR / "null_models_parquet"

FIG_DIR.mkdir(parents=True, exist_ok=True)
OUTPUT_DATA_DIR.mkdir(parents=True, exist_ok=True)
NULL_MODELS_DIR.mkdir(parents=True, exist_ok=True)
...
if __name__ == "__main__":
    try:
        ...
        generate_null_models(G_real, NUM_NULL_MODELS, NULL_MODELS_DIR)
