#!/bin/bash
#SBATCH --job-name=GRN_Clust_Directed       # Sets the job's name shown in the queue
...
#SBATCH --time=96:00:00         			# If the job takes more time than specified, is remode from the queue
...
# Execute
srun -n1 conda run --prefix=/exports/ana-scarlab/jmartinezcazon/envs/celloracle_env python 07_clustering_directed.py