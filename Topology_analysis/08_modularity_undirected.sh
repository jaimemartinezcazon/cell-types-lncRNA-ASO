#!/bin/bash
#SBATCH --job-name=GRN_Mod_Undirected       # Sets the job's name shown in the queue
...
# Execute
srun -n1 conda run --prefix=/exports/ana-scarlab/jmartinezcazon/envs/celloracle_env python 08_modularity_undirected.py