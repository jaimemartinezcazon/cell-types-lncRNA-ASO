#!/bin/bash
#SBATCH --job-name=GRN_Assortativity        # Sets the job's name shown in the queue
...
# Execute
srun -n1 conda run --prefix=/exports/ana-scarlab/jmartinezcazon/envs/celloracle_env python 14_assortativity.py