#!/bin/bash
#SBATCH --job-name=GRN_Clust_Undirected     # Sets the job's name shown in the queue
...
# Execute
srun -n1 conda run --prefix=/exports/ana-scarlab/jmartinezcazon/envs/celloracle_env python 06_clustering_undirected.py